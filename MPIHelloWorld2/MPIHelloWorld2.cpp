// MPIHelloWorld2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, char **argv)
{
  ...
  if (my_rank == 0) {
    ...
    {
      sprintf_s(buf, "Hello %i!", other_rank);
    ...
    assert(memcmp(buf, "Hello ", 6) == 0),
      ...
      sprintf_s(buf, "Process %i reporting for duty.", my_rank);
